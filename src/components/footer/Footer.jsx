...
const Footer = () => {
  return (
    <footer className="py-8 bg-black text-white ">
      ...
      <div className="mx-14 text-base font-semibold py-6 flex justify-between">
        <a href="#">
      ...
      <div className="my-6 mx-4 text-sm flex gap-4 font-semibold">
        <a href="#">Legal</a>
        <a href="#">Privacy Policy</a>
        <a href="#">Cookies</a>
      </div>
      <div className="text-xs font-semibold mx-4 text-center tracking-[0.4px] leading-5">
        <p>
