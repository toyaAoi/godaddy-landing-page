  ...
  return (
    <footer className="py-8 bg-black text-white ">
      ...
      <div className="grid max-sm:[grid-template-areas:'lo_lo_._._''hr_hr_hr_hr''cr_cr_cr_cr''sl_sl_sl_sl'] sm:[grid-template-areas:'._cr_._._''hr_hr_hr_hr''lo_lo_._sl']">
        ...
        <hr className="border-t-white [grid-area:hr]" />
        <div className="mx-14 text-base font-semibold py-6 flex justify-between [grid-area:cr] sm:px-24">
          <a href="#">
            India - English <FontAwesomeIcon icon={faChevronUp} />
          </a>
          <a href="#">
            INR ₹ <FontAwesomeIcon icon={faChevronUp} />
          </a>
        </div>
        <div className="flex justify-around items-center opacity-70 [grid-area:sl] sm:mr-6">
          <a href="#">
      ...
      <div className="sm:flex sm:flex-row-reverse sm:mx-4 sm:gap-4">
        ...
        <div className="text-xs font-semibold mx-4 tracking-[0.4px] leading-5 max-sm:text-center">
          <p>
